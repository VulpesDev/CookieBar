    ...
    function eventCookieBannerDetailsClicked(e) {
        ...
        var cookieBannerNotice = document.getElementById('CookieBannerNotice');
        document.getElementById('CookieBannerNotice').style.display = "none";
        if (cookieBannerWrapper) {
        cookieBannerWrapper.classList.toggle('is-details-open');
        cookieBannerNotice.classList.toggle('is-details-notice')
        }
        if (e.currentTarget) {
